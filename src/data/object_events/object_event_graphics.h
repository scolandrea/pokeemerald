...
const u16 gObjectEventPal_CatChallengeMom[] = INCBIN_U16("graphics/object_events/palettes/cat_challenge_mom.gbapal");
const u16 gObjectEventPal_CatChallengeDad[] = INCBIN_U16("graphics/object_events/palettes/cat_challenge_dad.gbapal");
