...
const u32 gMonFrontPic_Cosme[] = INCBIN_U32("graphics/pokemon/cosme/anim_front.4bpp.lz");
const u32 gMonFrontPic_Tita[] = INCBIN_U32("graphics/pokemon/tita/anim_front.4bpp.lz");
